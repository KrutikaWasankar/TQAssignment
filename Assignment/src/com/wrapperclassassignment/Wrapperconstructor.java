...
public class Wrapperconstructor {
	 ...
	 * 
	 * /* Wrapper Class Character has only one constructor which takes char type as
	 * an argument. It doesn’t have a constructor which takes String as an argument.
	 * Because, String can not be converted into Character.
	 * 
	 * /* Wrapper class Float has three constructors. The third constructor takes
	 * double type as an argument.
	 */
