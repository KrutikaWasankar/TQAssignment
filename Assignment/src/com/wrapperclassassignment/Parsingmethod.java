...
public class Parsingmethod {
	/*
	 * All wrapper classes in java have methods to parse the given string to
	 * corresponding primitive data provided the string should be parse-able. If the
	 * string is not parse-able, you will get NumberFormatException. All parsing
	 * methods of wrapper classes are static i.e you can refer them directly using
	 * class name.
	 */
